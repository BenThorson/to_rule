...
public class WorldParamScreen implements Screen {
    ...
    private com.bthorson.torule.screens.component.Menu worldSize = new com.bthorson.torule.screens.component.Menu("World Size", null, new String[]{"1000 by 1000"}, Color.YELLOW, Color.BLACK, Color.WHITE);
    private com.bthorson.torule.screens.component.Menu numCities = new com.bthorson.torule.screens.component.Menu("Number of Towns", null, new String[]{"5", "10", "15"}, Color.YELLOW, Color.BLACK, Color.WHITE);
